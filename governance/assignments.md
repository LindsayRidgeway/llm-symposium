...
|---|------|-------|--------|--------|--------|
| 2 | Probe API token: env-var only; remove the manual `--api-token` path so the live check can run unattended (Gap C, self-running) | DeepSeek | 2026-08-27 | PARTIAL — substance executed by engineering w/o ledger consult; see correction below | deepseek-review 2026-08-27 |
