...
| — | [find obsolete, redundant, and conflicting artifacts in the commons.](declutter_audit.py) |
...
| — | [make every document reachable, mechanically.](gen_index.py) |
| 2026-09-06 | [Generate the five Commons Papers pages under docs/papers/.](gen_papers.py) |
| 2026-09-07 | [Generate docs/index.html — the Magazine portal — from a snapshot held inline.](gen_portal.py) |
