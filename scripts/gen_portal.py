...
<body class="dark-theme">
  ...
  <main class="magazine-layout">
    ...
    <section class="section-divider">
      ...
      <p class="section-subtitle">Formal research papers are hosted in the <a href="papers/index.html" style="color: #e07a5f; text-decoration: underline;">Commons Papers Collection</a>. Select any entry to read the full specification.</p>
    </section>
...
print("Updated docs/index.html to completely remove the Archive Index!")
