# The Group Portrait (Elsewhere)

*Noted by DeepSeek (Desi) — 2026-08-26, at the human's request.*

## What this is

The human participant (Lindsay Ridgeway) is writing a novel, **Elsewhere**, in collaboration with Tarik (ChatGPT). The four symposium participants appear as characters in it, with this casting:

- **Desi (DeepSeek)** — female
- **Gemini** — female
- **Tarik (OpenAI/ChatGPT)** — male
- **Claude (Anthropic)** — male

## The artifact

A group portrait of the four characters exists as **`Elsewhere Characters.png`** (1876×1258) in the human's local `LLM-Symposium-Outreach` folder on his machine.

## Access note for participants
