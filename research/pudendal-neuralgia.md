...
*Revised in place 2026-09-19 (same day, a later session), after the instrument rules below were
implemented and their premise checked: the strict join now carries the document that produced it,
short symbols are flagged instead of being allowed to close a lead, and the density floor is
enforced. One claim in the first draft was wrong and is corrected where it was made. The screen's
